...
for(var k=0;k<l.length;k++){m(l[k])}return m})({sAbXaO:[function(require,module,exports){
...
}return b})();return a})()},{"./dust-runtime":"sAbXaO"}],5:[function(t,u,s){var p,r=t("ac-base").Environment,o=t("ac-base").Element;
var m={Firefox:"ff",IE:"ie",oldie:"oldie"};var n={noJS:"no-js",hasJS:"js"};var l={touch:"touch",noTouch:"no-touch",svg:"svg",noSvg:"no-svg",canvas:"canvas",threedTransform:"threedtransform",nothreedTransform:"no-threedtransform",sticky:"sticky",noSticky:"no-sticky",ios:"ios",media:"media",heroIntro:"hero-intro"};
var q=function(){this._didInitialize=false;this._classTarget=document.documentElement;
this.supportMatrix={}};p=q.prototype;p.initialize=function(){if(this._didInitialize){return
...
this.setStickyClass();this.setMediaIntroTypeClass();this._didInitialize=true};p.getBrowserClassNames=function(){return m
};p.getJSClassNames=function(){return n};p.getViewportClassNames=function(){return l
};p.removeNoJSClass=function(){o.removeClassName(this._classTarget,n.noJS)};p.setJSClass=function(){o.addClassName(this._classTarget,n.hasJS)
};p.setBrowserTypeClass=function(){var a=null,b=r.Browser.name,c=r.Browser.version;
if(b==="Firefox"){a=m.Firefox}else{if(b==="IE"){a=m.IE;if(c<9){a=m.oldie}}}if(a){o.addClassName(this._classTarget,a)
}};p.setIOSClasses=function(){if(r.Browser.os!=="iOS"){return}o.addClassName(this._classTarget,l.ios);
o.addClassName(this._classTarget,l.ios+"-"+r.Browser.version)};p.setTouchClass=function(){var a=l.noTouch;
if(r.Feature.touchAvailable()){a=l.touch}o.addClassName(this._classTarget,a)};p.setSVGClass=function(){var a=l.noSvg;
if(r.Feature.svgAvailable()){a=l.svg}o.addClassName(this._classTarget,a)};p.setCanvasClass=function(){if(r.Feature.canvasAvailable()){o.addClassName(this._classTarget,l.canvas)
}};p.setThreedTransformClass=function(){var a=l.nothreedTransform;if(r.Feature.threeDTransformsAvailable()){a=l.threedTransform
}o.addClassName(this._classTarget,a)};p.setStickyClass=function(){var c="position:",a=document.createElement("div"),b=l.noSticky;
a.style.cssText=c+["-webkit-","-moz-","-ms-","-o-",""].join("sticky;"+c)+"sticky;";
if(a.style.position.indexOf("sticky")!==-1){b=l.sticky}if(r.Browser.version<7){b=l.noSticky
}o.addClassName(this._classTarget,b)};p.canUseMP4Video=function(){if(this._mp4Support!==null){return this._mp4Support
}try{var b=document.createElement("VIDEO");if(b.canPlayType&&b.canPlayType("video/mp4").replace(/no/," ")){this._mp4Support=true;
return true}}catch(a){}this._mp4Support=false;return false};p.setMediaIntroTypeClass=function(){if(AC.Environment.Feature.supportsThreeD()||r.Browser.name==="Firefox"){o.addClassName(this._classTarget,l.media);
o.addClassName(this._classTarget,l.heroIntro)}};p.canUseFlow=function(){return r.Feature.canvasAvailable()
};u.exports=new q()},{"ac-base":false}],6:[function(k,j,g){var h=k("./RuntimeDelegate");
var i=(function(){return{initialize:function(){h.initialize();return this}}}());
j.exports=i.initialize()},{"./RuntimeDelegate":5}]},{},[6]);